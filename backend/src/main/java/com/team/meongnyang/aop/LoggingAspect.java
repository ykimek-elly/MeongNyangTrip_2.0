...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.team.meongnyang..controller..*(..))")
    private void controllerMethods() {
    }

    @Pointcut("execution(public * com.team.meongnyang..service..*(..))")
    private void serviceMethods() {
    }

    @Pointcut("execution(* com.team.meongnyang..*Calculator.*(..))")
    private void calculatorMethods() {
    }

    @Around("(controllerMethods() || serviceMethods()) && !calculatorMethods()")
