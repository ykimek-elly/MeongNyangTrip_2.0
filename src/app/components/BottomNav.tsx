...
import { Home, BotMessageSquare, User, MessageCircle } from 'lucide-react';
import { MapNavOutlineIcon, MapNavFilledIcon } from './CustomIcon';
...
export function BottomNav({ activeTab, onNavigate }: BottomNavProps) {
  const tabs: NavItem[] = [
    ...
    { id: 'map', label: '지도', icon: MapNavOutlineIcon, iconActive: MapNavFilledIcon },
