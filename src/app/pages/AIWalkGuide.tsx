        ...
        {!showRecommendation ? (
          ...
          >
            ...
            {isLoggedIn && pet ? (
              ...
              <>
                ...
                <div className="bg-white rounded-3xl p-5 shadow-sm border border-gray-100">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      { id: 'LOW', label: '적음', icon: '🐢' },
                      { id: 'NORMAL', label: '보통', icon: '🐕' },
                      { id: 'HIGH', label: '많음', icon: '⚡' }
                    ].map((activity) => (
                      <button
                        key={activity.id}
                      ...
                      >
                        ...
                        <div className={`font-bold text-sm ${selectedActivity === activity.id ? 'text-primary' : 'text-gray-600'}`}>
                          {activity.label}
                        </div>
                      </button>
                    ))}
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full bg-primary text-white font-bold py-4 rounded-2xl shadow-lg hover:bg-primary/90 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <button
                ...
                className="py-3 bg-gray-100 text-gray-700 font-bold rounded-xl hover:bg-gray-200 transition-colors"
              >
                다시 설정
              </button>
              <button
                onClick={handleSaveRoute}
                className="py-3 bg-primary text-white font-bold rounded-xl hover:bg-primary/90 transition-colors relative"
              >
                추천 경로 저장
              </button>
            </div>
