...
import { Search, MapPin, Calendar, Layers, TreeDeciduous, PawPrint, Dog, Cat, Tent, Coffee, Bed, ChevronRight, Star, Gift, Flame, MessageCircle, BotMessageSquare, Heart, Award, Camera, X, LogIn, Map } from 'lucide-react';
import { ChatBubbleOutlineIcon } from '../components/CustomIcon';
